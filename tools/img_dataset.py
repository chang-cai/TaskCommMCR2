...
class MultiviewImgDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir, scale_aug=False, rot_aug=False, test_mode=False, \
                 num_classes=40, num_views=12, train_objects=80, test_objects=20, shuffle=True):
        ...
        self.train_file_number = self.train_objects * self.num_views
        self.test_file_number = self.test_objects * self.num_views
    ...
    def __getitem__(self, idx):
        ...
        class_name = path.split('/')[-3]  # Linux
        # class_name = path.split('/')[-2]  # Win
...
class SingleImgDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir, scale_aug=False, rot_aug=False, test_mode=False,
                 num_classes=40, num_views=12, train_objects=80, test_objects=20):
